 ...
 * @author Amalina
 */
public class AfterModify extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jt_BillDetailsAM = new javax.swing.JTable();
        ...
        jt_BillDetailsAM.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jt_BillDetailsAM.getTableHeader().setReorderingAllowed(false);
        jt_BillDetailsAM.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jt_BillDetailsAMMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jt_BillDetailsAM);
...
Billing m = new Billing(); //set new window
    ...
    private void jt_BillDetailsAMMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jt_BillDetailsAMMouseClicked
        // TODO add your handling code here:
        int row = jt_BillDetailsAM.getSelectedRow();
        getItemCode = (jt_BillDetailsAM.getModel().getValueAt(row, 0).toString());
        Edit m = new Edit(); //set new window
        m.setVisible(true);//set new window visible
        dispose(); // for hide current window
        System.out.println("Table_click2" + Table_click2);

    }//GEN-LAST:event_jt_BillDetailsAMMouseClicked
    ...
    public void billdetails() {
         try {
                ...
                DefaultTableModel model1 = (DefaultTableModel) jt_BillDetailsAM.getModel();
...
//                System.out.println("i " + i);
                ...
                for (int i = 0; i < data.size(); i++) {
                    ...
                    jt_BillDetailsAM.setValueAt(data.get(i).get(7), i, 0);
                    jt_BillDetailsAM.setValueAt(data.get(i).get(8), i, 1);
                    jt_BillDetailsAM.setValueAt(data.get(i).get(9), i, 2);
                    jt_BillDetailsAM.setValueAt(data.get(i).get(10), i, 3);
                    jt_BillDetailsAM.setValueAt(data.get(i).get(11), i, 4);
...
//            System.out.println(gt);
    ...
    private javax.swing.JTable jt_BillDetailsAM;
